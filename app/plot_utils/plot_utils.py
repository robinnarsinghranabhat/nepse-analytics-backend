...
def plot_candelstick(spec, date_col=None, open=None, high=None, low=None,close=None, vol=None):
    ...
    go.Candlestick(x=spec[date_col],
                    open=spec[open],
                    high=spec[high],
                    low=spec[low],
                    close=spec[close],
    ...
    fig.add_trace(go.Candlestick(x=spec[date_col],
                    open=spec[open],
                    high=spec[high],
                    low=spec[low],
                    close=spec[close]),
